// FRAGMENT 3/3 -- sprites, maps, state, save/load, audio, movement, rendering,
// tiles/buildings/decorations, UI, and the closing '})();' for the shared closure
// opened in 00-engine-head.js.
